<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mt-3">
    <h1 class="display-6-teal-md mb-0">Edit Category</h1>
  </div>
          ...
          <div class="row">
            <div class="col-xl-3 col-lg-5 col-md-6 col-sm-12">
              ...
              <div class="form-group small">
                ...
                <input type="text" class="form-control form-control-sm rounded-0" id="category_nm" value="<?= $category[0]->category_nm; ?>">
              </div>
          ...
          <div class="row">
            <div class="col-xl-3 col-lg-5 col-md-6 col-sm-12">
              ...
              <div class="form-group text-right">
                ...
                <button type="button" class="btn btn-outline-orange-md btn-sm rounded-0 shadow-2dp" onclick="remove_category()">
                  <i class="fas fa-times"></i> Delete
                </button>
                <button type="button" class="btn btn-outline-teal-md btn-sm rounded-0 shadow-2dp" onclick="edit_category()">
