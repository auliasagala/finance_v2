<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mt-3">
    <h1 class="display-6-teal-md mb-0">Categories</h1>
    <a href="<?= base_url('engine/new_category'); ?>" class="btn btn-outline-teal-md btn-sm rounded-0 shadow-2dp"><i class="fas fa-sm fa-plus"></i> New Category</a>
  </div>
